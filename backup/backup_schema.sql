...
--
-- Name: signals_next_seq(smallint, integer, smallint, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.signals_next_seq(p_exchange_id smallint, p_symbol_id integer, p_screener_id smallint, p_signal_day date) RETURNS integer
    LANGUAGE plpgsql
    AS $$
...
--
-- Name: screener_runs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: screener_runs_run_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.screener_runs_run_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: screener_runs_run_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.screener_runs_run_id_seq OWNED BY public.screener_runs.run_id;


--
-- Name: screener_signals; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.screener_signals (
...
--
-- Name: screener_signals_signal_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.screener_signals_signal_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: screener_signals_signal_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.screener_signals_signal_id_seq OWNED BY public.screener_signals.signal_id;


--
-- Name: screeners; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: screeners_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.screeners_id_seq
    AS smallint
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: screeners_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.screeners_id_seq OWNED BY public.screeners.screener_id;
...
--
-- Name: signals_day_seq; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.signals_day_seq (
    exchange_id smallint NOT NULL,
    symbol_id integer NOT NULL,
    screener_id smallint NOT NULL,
    signal_day date NOT NULL,
...
--
-- Name: screener_runs run_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_runs ALTER COLUMN run_id SET DEFAULT nextval('public.screener_runs_run_id_seq'::regclass);


--
-- Name: screener_signals signal_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_signals ALTER COLUMN signal_id SET DEFAULT nextval('public.screener_signals_signal_id_seq'::regclass);


--
-- Name: screeners screener_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screeners ALTER COLUMN screener_id SET DEFAULT nextval('public.screeners_id_seq'::regclass);
...
--
-- Name: screener_runs screener_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_runs
    ADD CONSTRAINT screener_runs_pkey PRIMARY KEY (run_id);


--
-- Name: screener_signals screener_signals_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_signals
    ADD CONSTRAINT screener_signals_pkey PRIMARY KEY (signal_id);


--
-- Name: screeners screeners_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screeners
    ADD CONSTRAINT screeners_name_key UNIQUE (name);


--
-- Name: screeners screeners_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screeners
    ADD CONSTRAINT screeners_pkey PRIMARY KEY (screener_id);


--
-- Name: signals_day_seq signals_day_seq_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals_day_seq
    ADD CONSTRAINT signals_day_seq_pkey PRIMARY KEY (exchange_id, symbol_id, screener_id, signal_day);


--
-- Name: signals signals_exchange_id_symbol_id_screener_id_signal_day_day_se_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals
    ADD CONSTRAINT signals_exchange_id_symbol_id_screener_id_signal_day_day_se_key UNIQUE (exchange_id, symbol_id, screener_id, signal_day, day_seq);


--
-- Name: signals signals_exchange_id_symbol_id_screener_id_timeframe_signal__key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals
    ADD CONSTRAINT signals_exchange_id_symbol_id_screener_id_timeframe_signal__key UNIQUE (exchange_id, symbol_id, screener_id, timeframe, signal_ts);
...
--
-- Name: idx_oi_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_oi_lookup ON public.open_interest USING btree (exchange_id, symbol_id, "interval", ts DESC);
...
--
-- Name: ix_screener_runs_screener_started; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_screener_runs_screener_started ON public.screener_runs USING btree (screener_id, started_at DESC);


--
-- Name: ix_signals_screener_day_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_signals_screener_day_desc ON public.signals USING btree (screener_id, signal_day DESC, day_seq DESC);


--
-- Name: ix_signals_symbol_ts_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_signals_symbol_ts_desc ON public.signals USING btree (symbol_id, signal_ts DESC);


--
-- Name: ix_signals_ts_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_signals_ts_desc ON public.signals USING btree (signal_ts DESC);
...
--
-- Name: ux_screener_signals_idem; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_screener_signals_idem ON public.screener_signals USING btree (screener_id, exchange_id, symbol_id, timeframe, signal_ts, side);
...
--
-- Name: screener_runs screener_runs_screener_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_runs
    ADD CONSTRAINT screener_runs_screener_id_fkey FOREIGN KEY (screener_id) REFERENCES public.screeners(screener_id) ON DELETE CASCADE;


--
-- Name: screener_signals screener_signals_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_signals
    ADD CONSTRAINT screener_signals_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.screener_runs(run_id) ON DELETE SET NULL;


--
-- Name: screener_signals screener_signals_screener_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screener_signals
    ADD CONSTRAINT screener_signals_screener_id_fkey FOREIGN KEY (screener_id) REFERENCES public.screeners(screener_id) ON DELETE CASCADE;


--
-- Name: signals_day_seq signals_day_seq_exchange_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals_day_seq
    ADD CONSTRAINT signals_day_seq_exchange_id_fkey FOREIGN KEY (exchange_id) REFERENCES public.exchanges(exchange_id) ON DELETE CASCADE;


--
-- Name: signals_day_seq signals_day_seq_screener_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals_day_seq
    ADD CONSTRAINT signals_day_seq_screener_id_fkey FOREIGN KEY (screener_id) REFERENCES public.screeners(screener_id) ON DELETE CASCADE;


--
-- Name: signals_day_seq signals_day_seq_symbol_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals_day_seq
    ADD CONSTRAINT signals_day_seq_symbol_id_fkey FOREIGN KEY (symbol_id) REFERENCES public.symbols(symbol_id) ON DELETE CASCADE;


--
-- Name: signals signals_exchange_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals
    ADD CONSTRAINT signals_exchange_id_fkey FOREIGN KEY (exchange_id) REFERENCES public.exchanges(exchange_id) ON DELETE CASCADE;


--
-- Name: signals signals_screener_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals
    ADD CONSTRAINT signals_screener_id_fkey FOREIGN KEY (screener_id) REFERENCES public.screeners(screener_id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.signals
    ADD CONSTRAINT signals_symbol_id_fkey FOREIGN KEY (symbol_id) REFERENCES public.symbols(symbol_id) ON DELETE CASCADE;
