...
class TradeLiquidationParams:
    ...
    hedge_reopen_order_offset_pct: float = 0.0  # 0=use legacy move pct fallback; otherwise explicit % distance of hedge opener from anchor
    hedge_reopen_order_min_reprice_pct: float = 0.5  # minimum trigger change (%) to refresh pending anchor hedge
    hedge_reopen_reprice_cooldown_sec: float = 30.0  # cooldown between anchor hedge reprices
    ...
    def from_dict(cls, d: Dict[str, Any]) -> "TradeLiquidationParams":
        ...
        params["hedge_reopen_order_offset_pct"] = float(_as_float(params.get("hedge_reopen_order_offset_pct", cls().hedge_reopen_order_offset_pct), cls().hedge_reopen_order_offset_pct) or cls().hedge_reopen_order_offset_pct)
        params["hedge_reopen_order_min_reprice_pct"] = float(_as_float(params.get("hedge_reopen_order_min_reprice_pct", cls().hedge_reopen_order_min_reprice_pct), cls().hedge_reopen_order_min_reprice_pct) or cls().hedge_reopen_order_min_reprice_pct)
        params["hedge_reopen_reprice_cooldown_sec"] = float(_as_float(params.get("hedge_reopen_reprice_cooldown_sec", cls().hedge_reopen_reprice_cooldown_sec), cls().hedge_reopen_reprice_cooldown_sec) or cls().hedge_reopen_reprice_cooldown_sec)
